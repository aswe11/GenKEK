...
ConfMan::InitializeHistograms( void )
{
  ...
  HB1(genfitHid+10, "[GenFit] q/p;pull; Number of Tracks", 240, -12, 12);
  HB1(genfitHid+11, "[GenFit] slope u';pull; Number of Tracks", 240, -12, 12);
  HB1(genfitHid+12, "[GenFit] slope v';pull; Number of Tracks", 240, -12, 12);
  HB1(genfitHid+13, "[GenFit] coord. u;pull; Number of Tracks", 240, -12, 12);
  HB1(genfitHid+14, "[GenFit] coord. v;pull; Number of Tracks", 240, -12, 12);
